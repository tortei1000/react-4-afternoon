    ...
    return (
      <div>
        <div className='subnav'>
          <Link to="/about" className='subnav'><h3>About</h3></Link>
          <Link to="/about/history" className='subnav'><h3>History</h3></Link>
          <Link to="/about/contact" className='subnav'><h3>Contact</h3></Link>
        </div>
        <div className='box'>
          <Switch>
